...
with webdriver.Chrome(
    ...
    columns = driver.find_element(By.CSS_SELECTOR, "table.ds-w-full.ds-table.ds-table-xs.ds-table-fixed.ci-scorecard-table:first-of-type thead tr.ds-border-b.ds-border-line.ds-text-tight-s")
    ...
    for batter in batters:
        try:
            name = batter.find_element(By.CSS_SELECTOR, "td.ds-min-w-max > span.ds-inline-flex.ds-items-center.ds-leading-none > a.ds-text-ui-typo.ds-underline.ds-underline-offset-4.ds-decoration-ui-stroke").get_attribute("title")
